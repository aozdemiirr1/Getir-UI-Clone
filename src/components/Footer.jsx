...
const Footer = () => {
  return (
    <footer className='bg-white border-t mt-20 py-20 flex flex-col'>
        <div className="flex flex-row justify-between container mx-auto border-b pb-10">
        ...
        <div className="flex flex-row justify-between items-center container mx-auto pt-10">
            <div className="flex flex-row gap-x-4 ">
                <span className='text-gray-500'>© 2024 Getir</span>
                <a href="#" className='text-purple-400'>Bilgi Toplumu Hizmetleri</a>
            </div>
            <a href="#" className='flex flex-row gap-x-3 items-center border border-gray-00 px-3 hover:bg-purple-100 text-gray-500 hover:text-purple-500'>
