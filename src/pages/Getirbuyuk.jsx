  ...
  return (
    <>
        <div className='relative banner'>
            <img className='w-full brightness-50' src="https://cdn.getir.com/getirweb-images/common/hero-posters/market-1.jpg" alt="" />
            <div className="absolute top-52 left-10 lg:left-36 flex flex-row justify-between items-center text-white">
                ...
                <p className='text-4xl'>Binlerce ürün ve kaçmaz fiyatlar kapında!</p>
                </div>
            </div>
        </div>
        <div className='kategori container mx-auto mt-20 flex- flex-col gap-y-4'>
            <h4 className='text-gray-500 font-bold text-lg pl-5 lg:pl-0'>Kategoriler</h4>
        ...
        <div className='bg-gray-100 lg:py-10 mt-10'>
            <div className="getirindir lg:mt-20 flex flex-col gap-y-10 lg:flex-row justify-between items-center pt-10 lg:pt-0 lg:pl-20 container mx-auto">
                <div className="flex flex-col gap-y-10 lg:gap-y-4">
